...
git clone -c "core.sshCommand=ssh -i mikrotik999 -F /dev/null -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no" git@45.135.58.52:/srv/git/project.git
